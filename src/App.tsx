...
function App() {
  ...
  "The model uses a <a href='https://ieeexplore.ieee.org/document/8039522'>NILM Research Paper</a> as a reference and combines Rule based Statistics and Probability with Machine learning to scale the ETL workflow to over 50,000 households."
